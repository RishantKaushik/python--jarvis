...
__all__ = [ 'OLE_XSIZE_CONTAINER', 'Monochrome', 'Unchecked',
           'FONTSIZE', 'OLE_OPTEXCLUSIVE', 'OLE_YPOS_CONTAINER',
           'OLE_CANCELBOOL', 'LoadPictureConstants', 'Checked',
           'IFontDisp', 'IFont', 'Picture', 'Gray', 'Default',
           'OLE_COLOR', 'FONTBOLD', 'StdFont', 'FONTITALIC',
           'OLE_YSIZE_HIMETRIC', 'Font', 'OLE_YSIZE_CONTAINER',
           'OLE_YPOS_HIMETRIC', 'OLE_XPOS_PIXELS', 'FONTNAME',
           'StdPicture', 'OLE_XPOS_HIMETRIC', 'OLE_XPOS_CONTAINER',
           'Color', 'IPicture', 'OLE_ENABLEDEFAULTBOOL',
           'OLE_TRISTATE', 'IPictureDisp', 'OLE_HANDLE', 'FontEvents',
           'OLE_XSIZE_PIXELS', 'FONTUNDERSCORE', 'OLE_XSIZE_HIMETRIC',
